...
export const switchFriendCode = socialMedias["switch-friend-code"];
...
// OBS
const obsConfig = require(CONFIGS_FOLDER + "configObs.json");
...
// Sql
const sqlConfig = require(CONFIGS_FOLDER + "configSql.json");
